    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.inputRow}>
        ...
        <View style={styles.cardIcons}>
          ...
          <View style={[styles.cardDot, { backgroundColor: "#f79e1b", marginLeft: -10 }]} />
        </View>
        <Image source={require("./assets/Payment/Card Icon.png")} style={styles.cardIconImg} />
      </View>
...
const styles = StyleSheet.create({
  ...
  inputRow: {
    ...
    backgroundColor: "#f7f7f7", borderRadius: 12, paddingRight: 8,
  },
  cardIconImg: { width: 36, height: 36, resizeMode: "contain" },
  cardIcons: { flexDirection: "row", alignItems: "center", marginRight: 6 },
